...
public class AddProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(priceParam!=null){
            ...
            status="Price can't be left blank";
            request.setAttribute("message",status);
            rd=request.getRequestDispatcher("addProduct.jsp");
            rd.forward(request, response);
            return ;
        ...
        String qty=request.getParameter("quantity");
         if(qty!=null){
            try{
                prodQuentity=Integer.parseInt(qty);
            ...
            status="Quantity can't be left blank";
            request.setAttribute("message",status);
            rd=request.getRequestDispatcher("addProduct.jsp");
            rd.forward(request, response);
            return ;
        ...
        ProductPojo product=new ProductPojo(null,prodName,prodType,prodInfo,prodPrice,prodQuentity,img);
