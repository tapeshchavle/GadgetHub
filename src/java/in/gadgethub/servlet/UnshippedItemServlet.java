...
public class UnshippedItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrderPojo> orders=orderDao.getUnshippedOrderDetails();      
        UserDaoImpl userDao=new UserDaoImpl();
        TransactionDaoImpl transaction=new TransactionDaoImpl();
        List<ItemDetails> unShippedItems=new ArrayList<>();
