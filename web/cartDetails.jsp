...
<%@page import="in.gadgethub.pojo.CartPojo"%>
                ...
                <tbody> 
                    <% 
                              /* Java Code */ 
                                ...
                                Map<Integer,Object> map=(Map<Integer,Object>)request.getAttribute("map");
                                double totalAmount=0.0;                                
                                for(CartPojo cp:cartItems){
                                    String prodId=cp.getProdId();
                                    int prodQuantity=cp.getQuantity();
                                    ProductPojo product=(ProductPojo)map.get(cp.getProdId());
                    ...
                    <tr> 
                        ...
                        <td><form method="post" action="./UpdateToCartServlet"> 
                                <input type="number" name="pQty" value="<%=cp.getQuantity()%>" 
